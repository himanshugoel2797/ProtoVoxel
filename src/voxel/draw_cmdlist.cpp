...
void PVV::DrawCmdList::RecordDraw(uint32_t count, uint32_t firstIndex, uint32_t baseVertex, uint32_t baseInstance, uint32_t instanceCount, glm::ivec3 &pos, glm::ivec3 &min_bnd, glm::ivec3 &max_bnd)
{
#ifdef DEBUG
